...
async fn get_connection_pool(db_uri: &str) -> Result<Pool<Postgres>, MlflowError> {
...
impl PostgresStore {
    ...
    ) -> Result<PostgresStore, MlflowError> {
    ...
    pub async fn from_env() -> Result<PostgresStore, MlflowError> {
